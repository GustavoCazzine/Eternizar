...
const tipos = [
 { id: 'casal', label: 'Página do Casal', icon: '♥', cor: '#B91C3C', desc: 'Aniversário de namoro, Dia dos Namorados, surpresa romântica' },
...
const SUGESTOES_CASAL = [
 ...
 { emoji: '♥', titulo: 'Primeiro beijo', placeholder: 'Ex: Foi em uma noite de verão, depois daquele jantar...' },
...
function PassoTimeline({ form, upd, addEvento, addEventoComDados, removeEvento, updEvento, handleFotoEvento }: PassoProps) {
 ...
 {ev.foto && <span className="text-xs text-gray-500"></span>}
